...
const routes = [
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/Order-complete.vue"),
  },
   {
    path: "/login",
    name: "Login",
  ...
  },
  {
  ...
  },
   {
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/admin/Product.vue"),
  },
   {
    path: "/admin/orders",
    name: "order",
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/admin/Customer.vue"),
  },
];
