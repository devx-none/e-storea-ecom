...
<!-- breadcrum -->
    <div class="py-4 container flex gap-3 items-center">
        ...
        <span class="text-sm text-gray-400"><i class="fas fa-chevron-right"></i></span>
        <p class="text-gray-600 font-medium uppercase">{{products.ProductName}}</p>
    </div>
    <!-- breadcrum end -->
    <!-- product view -->
    <div class="container pt-4 pb-6 grid lg:grid-cols-2 gap-6">
        ...
        <div>
            <div>
                <img id="main-img" src='C:\xampp\htdocs\e-storea\front-end\src\assets\images\products\product9.jpg' class="w-full"/>
            </div>
            <div class="grid grid-cols-5 gap-4 mt-4">
                <div>
                    <img src="./assets/images/products/product9.jpg" class="single-img w-full cursor-pointer border border-primary">
                </div>
                <div>
...
export default {
  ...
  methods: {
    ...
    viewProduct(id) {
        var id= '#AAZ';
      axios
        .get("http://localhost:7882/e-storea/products/SingleProduct/"+id)
