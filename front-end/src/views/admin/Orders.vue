<template>
  <div class="container">
    ...
    <div class="main">
      ...
      <div class="details">
        <div class="products">
          <h4>Order <span class="numberOrder">100</span></h4>
          <div class="search-cont">
            <div class="box1">
              <a href="" class="link_item1 link">All</a>
              <a href="" class="link_item1 link">Delivered</a>
              <a href="" class="link_item1 link">Pending</a>
              <a href="" class="link_item1 link">Cancelled</a>
            </div>
            <div class="box2">
              <input
