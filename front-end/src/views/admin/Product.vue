          ...
          <table class="">
            ...
            <tbody>
              ...
              <tr v-for="product in products" :key="product">
                ...
                <td>$599</td>
                <td>Apple</td>
                <td><button class="btn edit"><i class="fas fa-edit"></i></button><button class="btn delete" @click="deleteProduct(product.ProductID)" ><i class="fas fa-trash-alt"></i></button></td>
              </tr>
...
export default {
  ...
  methods: {
    ...
    deleteProduct(id) {
      axios
      .delete(
         "http://localhost:7882/e-storea/products/DeleteProduct/"+id)
         .then((response)=> {
